...
TankBody::TankBody(std::string strObjectPath, glm::vec3 vecPosition, glm::vec3 vecScale) : Model3D(strObjectPath, vecPosition, vecScale) {
...
void TankBody::draw(Shaders& CShaders) {
