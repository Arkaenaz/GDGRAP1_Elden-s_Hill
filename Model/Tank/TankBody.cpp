...
TankBody::TankBody(std::string strObjectPath, std::string strTexturePath, glm::vec3 vecPosition, glm::vec3 vecScale) : Model3D(strObjectPath, strTexturePath, vecPosition, vecScale) {
