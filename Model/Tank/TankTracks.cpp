#include "TankTracks.hpp"

using namespace models;

TankTracks::TankTracks(std::string strObjectPath, glm::vec3 vecPosition, glm::vec3 vecScale) : Model3D(vecPosition, vecScale) {
    this->loadModel(strObjectPath.c_str());
    this->setupVAO();
}

void TankTracks::loadModel(const char *objectPath) {
...
void TankTracks::setShaderValues(Shaders &CShaders) {
