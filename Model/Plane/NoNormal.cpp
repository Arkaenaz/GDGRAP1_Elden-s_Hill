#include "NoNormal.hpp"

using namespace models;

NoNormal::NoNormal(std::string strObjectPath, glm::vec3 vecPosition, glm::vec3 vecScale) : Model3D(vecPosition, vecScale) {
    this->loadModel(strObjectPath.c_str());
    this->setupVAO();
}

void NoNormal::loadModel(const char *objectPath) {
...
void NoNormal::setShaderValues(Shaders &CShaders) {
